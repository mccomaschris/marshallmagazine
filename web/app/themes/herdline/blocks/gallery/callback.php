<?php
/**
 * Gallery block for herdline theme
 *
 * @package herdline
 */
 ...
 */
function herdline_gallery_block( $block, $content = '', $is_preview = false ) {
	$context               = Timber::context();
	$context['block']      = $block;
	$context['fields']     = get_fields() ? get_fields() : array();
	$context['is_preview'] = $is_preview;

	$classes = array( 'herdline-block', 'wp-block-herdline-gallery' );
	...
	Timber::render( 'blocks/gallery.twig', $context );
}
