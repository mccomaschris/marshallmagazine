<?php
/**
 * Callout block for herdline theme
 *
 * @package herdline
 */
 ...
 */
function herdline_callout_block( $block, $content = '', $is_preview = false ) {
	$context               = Timber::context();
	$context['block']      = $block;
	$context['fields']     = get_fields() ? get_fields() : array();
	$context['is_preview'] = $is_preview;

	$classes = array( 'herdline-block', 'wp-block-herdline-callout' );
	...
	Timber::render( 'blocks/callout.twig', $context );
}
