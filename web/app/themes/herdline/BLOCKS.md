...
| `pattern` | Select | Corner/tile: topleft, topright, bottomleft, bottomright, middlevs, graph, texture, topography, mountain. Side fills (desktop, opposite the text, faded toward the copy): side_dots, side_diagonal, side_grid, side_vertical, side_crosshatch, side_rings |
